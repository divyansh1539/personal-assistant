...
//       background: ${sender === "user" ? "#222" : "#8b0000"};
//       color: white;
//       margin: 10px 0;
//       padding: 12px 18px;
//       border-radius: 15px;
...
//       createBubble("Opening YouTube...", "bot");
//       speak("Opening YouTube...");
//       setTimeout(() => window.open("https://www.youtube.com", "_blank"), 1000);
//     } else if (q.includes("open google")) {
//       createBubble("Heading to Google...", "bot");
//       speak("Heading to Google...");
//       setTimeout(() => window.open("https://www.google.com", "_blank"), 1000);
//     } else if (q.includes("your name")) {
//       createBubble("I am the devil's assistant. Obeying your voice.", "bot");
//       speak("I am the devil's assistant. Obeying your voice.");
//     } else if (q.includes("time")) {
//       const time = new Date().toLocaleTimeString();
//       createBubble(`The dark hour is ${time}`, "bot");
//       speak(`The dark hour is ${time}`);
//     } else {
//       createBubble("That is unknown to even the shadows.", "bot");
//       speak("That is unknown to even the shadows.");
//     }
//   }
...
//     handleCommand(transcript); // don't fill input box
//   };
